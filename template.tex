...
\renewcommand{\refname}{\begin{center} \vspace{-40pt} \heiti\sanhao 参考文献 \end{center}}
...
{\wuhao\bibliography{references/references}}
\newpage
\include{appendice/thanks} % 致谢
\include{appendice/appendice} % 附录
